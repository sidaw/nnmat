...
L = {};
patchgen = LayerImage2Patch([28, 28], [8 8], 2);
patchlayer = LayerPatches(patchgen.dimpatches, numpatchhid, patchgen.numpatches);
patchact = LayerActivation(numpatchhid, 'relu');
patchlayer2 = LayerPatches(numpatchhid, numposes, patchgen.numpatches);
patch2flat = LayerFlattenPatches(numposes, patchgen.numpatches);
